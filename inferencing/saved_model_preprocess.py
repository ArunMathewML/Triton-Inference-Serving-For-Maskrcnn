...
class ForwardModel:
    def __init__(self, config):
        self.config = config1.mask_config()
        self.outputs = {
    ...
    def format_output(self, result):
        ...
        mask = result.as_numpy('mrcnn_mask/Reshape_1')
        ...
        detection = result.as_numpy('mrcnn_detection/Reshape_1')
    ...
    def result_to_dict(self, images, molded_images, windows, result_dict, is_restapi=False):
        ...
        results = []
        print(len(result_dict['detection']))
