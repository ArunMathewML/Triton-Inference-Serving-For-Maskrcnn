...
from external.mask_rcnn.mrcnn import utils
...
class PyramidROIAlign(KE.Layer):
    ...
    def call(self, inputs):
        ...
        for i, level in enumerate(range(2, 6)):
            ...
            #     method="bilinear"))
            pooled.append(self.NCHW_crop_and_resize(feature_maps[i], level_boxes,
    ...
    def compute_output_shape(self, input_shape):
        return input_shape[0][:2]  + (input_shape[2][1], ) + self.pool_shape #input_shape[0][:2] + self.pool_shape + (input_shape[2][-1], )
